...
export default {
  en: {
    ...
    step2Kicker: 'FOR YOUR SAFETY',
    step2Title: 'Allergens',
    step3Kicker: 'YOUR TASTE',
    step3Title: 'Diet & cuisines',
    step4Kicker: 'LAST STEP',
    step4Title: 'Cooking skill',
  ...
  tr: {
    ...
    step1Title: 'Senin hakkında',
    step2Kicker: 'GÜVENLİĞİN İÇİN',
    step2Title: 'Alerjenler',
    step3Kicker: 'DAMAK TADIN',
    step3Title: 'Beslenme ve mutfak',
    step4Kicker: 'SON ADIM',
    step4Title: 'Mutfak becerin',
